...
*-gx, --gravity-x*::
	 ...
	 set the image gravity center in the X axis at position (which can be a fixed amount or a percentage of the image width)

*-gy, --gravity-y*::

	 set the image gravity center in the Y axis at position (which can be a fixed amount or a percentage of the image height)
