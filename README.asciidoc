...
*--store*::
	 ...
	 stores valid invocation sequence in `${XDG_CONFIG_HOME:-$HOME/.config}/.setroot-restore`

*--restore*::

	 looks for `${XDG_CONFIG_HOME:-$HOME/.config}/.setroot-restore` and calls invocation sequence (restores your previously set wallpapers and options)
