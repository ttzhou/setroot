...
*--store*::
	 ...
	 stores valid invocation sequence in `${XDG_CONFIG_HOME:-$HOME/.config}/setroot/.setroot-restore` (you should create this path before using _--store_ or you will receive an error)
